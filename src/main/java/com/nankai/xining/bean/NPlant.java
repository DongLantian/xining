...
public class NPlant implements Serializable {
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPlantArea() == null ? other.getPlantArea() == null : this.getPlantArea().equals(other.getPlantArea()))
