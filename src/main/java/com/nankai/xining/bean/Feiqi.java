...
public class Feiqi implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", lon4=").append(lon4);
        sb.append(", lat1=").append(lat1);
        sb.append(", lat2=").append(lat2);
        sb.append(", lat3=").append(lat3);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getLon4() == null ? other.getLon4() == null : this.getLon4().equals(other.getLon4()))
            && (this.getLat1() == null ? other.getLat1() == null : this.getLat1().equals(other.getLat1()))
            && (this.getLat2() == null ? other.getLat2() == null : this.getLat2().equals(other.getLat2()))
            && (this.getLat3() == null ? other.getLat3() == null : this.getLat3().equals(other.getLat3()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLon4() == null) ? 0 : getLon4().hashCode());
        result = prime * result + ((getLat1() == null) ? 0 : getLat1().hashCode());
        result = prime * result + ((getLat2() == null) ? 0 : getLat2().hashCode());
        result = prime * result + ((getLat3() == null) ? 0 : getLat3().hashCode());
