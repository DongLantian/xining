...
public class BoilerTemp implements Serializable {
    private Integer id;
    ...
    private String combustionsystem;
    ...
    public String getCombustionsystem() {
        return combustionsystem;
    }

    public void setCombustionsystem(String combustionsystem) {
        this.combustionsystem = combustionsystem == null ? null : combustionsystem.trim();
    }
    ...
    public String getFuelAusageunit() {
        return fuelAusageunit;
    }

    public void setFuelAusageunit(String fuelAusageunit) {
    ...
    public String toString() {
        ...
        sb.append(", combustionsystem=").append(combustionsystem);
        sb.append(", fuelAusage=").append(fuelAusage);
        sb.append(", fuelAusageunit=").append(fuelAusageunit);
        ...
        sb.append(", installedCapacity=").append(installedCapacity);
    ...
    public boolean equals(Object that) {
        ...
        BoilerTemp other = (BoilerTemp) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getTboilerId() == null ? other.getTboilerId() == null : this.getTboilerId().equals(other.getTboilerId()))
            ...
            && (this.getCombustionsystem() == null ? other.getCombustionsystem() == null : this.getCombustionsystem().equals(other.getCombustionsystem()))
            && (this.getFuelAusage() == null ? other.getFuelAusage() == null : this.getFuelAusage().equals(other.getFuelAusage()))
            && (this.getFuelAusageunit() == null ? other.getFuelAusageunit() == null : this.getFuelAusageunit().equals(other.getFuelAusageunit()))
            ...
            && (this.getInstalledCapacity() == null ? other.getInstalledCapacity() == null : this.getInstalledCapacity().equals(other.getInstalledCapacity()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCombustionsystem() == null) ? 0 : getCombustionsystem().hashCode());
        result = prime * result + ((getFuelAusage() == null) ? 0 : getFuelAusage().hashCode());
        result = prime * result + ((getFuelAusageunit() == null) ? 0 : getFuelAusageunit().hashCode());
        ...
        result = prime * result + ((getInstalledCapacity() == null) ? 0 : getInstalledCapacity().hashCode());
