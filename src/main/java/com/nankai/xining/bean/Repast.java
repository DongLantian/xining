...
public class Repast implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", cookingNum=").append(cookingNum);
        sb.append(", cleanerNum=").append(cleanerNum);
        sb.append(", scccode=").append(scccode);
        sb.append(", smokeRate=").append(smokeRate);
        sb.append(", annualRuntime=").append(annualRuntime);
        sb.append(", removalEffi=").append(removalEffi);
        ...
        sb.append(", coalgasConsumption=").append(coalgasConsumption);
    ...
    public boolean equals(Object that) {
        ...
        Repast other = (Repast) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getFactoryid() == null ? other.getFactoryid() == null : this.getFactoryid().equals(other.getFactoryid()))
            && (this.getYear() == null ? other.getYear() == null : this.getYear().equals(other.getYear()))
            && (this.getCookingNum() == null ? other.getCookingNum() == null : this.getCookingNum().equals(other.getCookingNum()))
            && (this.getCleanerNum() == null ? other.getCleanerNum() == null : this.getCleanerNum().equals(other.getCleanerNum()))
            && (this.getScccode() == null ? other.getScccode() == null : this.getScccode().equals(other.getScccode()))
            && (this.getSmokeRate() == null ? other.getSmokeRate() == null : this.getSmokeRate().equals(other.getSmokeRate()))
            && (this.getAnnualRuntime() == null ? other.getAnnualRuntime() == null : this.getAnnualRuntime().equals(other.getAnnualRuntime()))
            && (this.getRemovalEffi() == null ? other.getRemovalEffi() == null : this.getRemovalEffi().equals(other.getRemovalEffi()))
            && (this.getHouseholdNum() == null ? other.getHouseholdNum() == null : this.getHouseholdNum().equals(other.getHouseholdNum()))
            ...
            && (this.getCoalgasConsumption() == null ? other.getCoalgasConsumption() == null : this.getCoalgasConsumption().equals(other.getCoalgasConsumption()))
            ...
            && (this.getOilConsumption() == null ? other.getOilConsumption() == null : this.getOilConsumption().equals(other.getOilConsumption()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCookingNum() == null) ? 0 : getCookingNum().hashCode());
        result = prime * result + ((getCleanerNum() == null) ? 0 : getCleanerNum().hashCode());
        result = prime * result + ((getScccode() == null) ? 0 : getScccode().hashCode());
        result = prime * result + ((getSmokeRate() == null) ? 0 : getSmokeRate().hashCode());
        result = prime * result + ((getAnnualRuntime() == null) ? 0 : getAnnualRuntime().hashCode());
        result = prime * result + ((getRemovalEffi() == null) ? 0 : getRemovalEffi().hashCode());
        result = prime * result + ((getHouseholdNum() == null) ? 0 : getHouseholdNum().hashCode());
        ...
        result = prime * result + ((getCoalgasConsumption() == null) ? 0 : getCoalgasConsumption().hashCode());
        ...
        result = prime * result + ((getOilConsumption() == null) ? 0 : getOilConsumption().hashCode());
