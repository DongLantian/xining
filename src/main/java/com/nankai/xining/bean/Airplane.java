...
public class Airplane implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", fuelSulfurUsage=").append(fuelSulfurUsage);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getFuelSulfurUsage() == null ? other.getFuelSulfurUsage() == null : this.getFuelSulfurUsage().equals(other.getFuelSulfurUsage()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getFuelSulfurUsage() == null) ? 0 : getFuelSulfurUsage().hashCode());
