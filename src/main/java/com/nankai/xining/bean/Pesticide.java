...
public class Pesticide implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", pesticideamount=").append(pesticideamount);
    ...
    public boolean equals(Object that) {
        ...
        Pesticide other = (Pesticide) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPesticideamount() == null ? other.getPesticideamount() == null : this.getPesticideamount().equals(other.getPesticideamount()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPesticideamount() == null) ? 0 : getPesticideamount().hashCode());
