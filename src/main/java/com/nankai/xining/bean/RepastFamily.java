...
public class RepastFamily implements Serializable {
    private Integer id;
    ...
    public Double getNonfarmNum() {
        return nonfarmNum;
    }

    public void setNonfarmNum(Double nonfarmNum) {
        this.nonfarmNum = nonfarmNum;
    }

    public Double getFarmNum() {
        return farmNum;
    }

    public void setFarmNum(Double farmNum) {
    ...
    public String toString() {
        ...
        sb.append(", nonfarmNum=").append(nonfarmNum);
        sb.append(", farmNum=").append(farmNum);
    ...
    public boolean equals(Object that) {
        ...
        RepastFamily other = (RepastFamily) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getNonfarmNum() == null ? other.getNonfarmNum() == null : this.getNonfarmNum().equals(other.getNonfarmNum()))
            && (this.getFarmNum() == null ? other.getFarmNum() == null : this.getFarmNum().equals(other.getFarmNum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getNonfarmNum() == null) ? 0 : getNonfarmNum().hashCode());
        result = prime * result + ((getFarmNum() == null) ? 0 : getFarmNum().hashCode());
