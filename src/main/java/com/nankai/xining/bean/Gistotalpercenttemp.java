...
public class Gistotalpercenttemp implements Serializable {
    private Integer id;
    ...
    public Double getEverypercent() {
        return everypercent;
    }

    public void setEverypercent(Double everypercent) {
        this.everypercent = everypercent;
    }
    ...
    public void setEverytype(String everytype) {
        this.everytype = everytype == null ? null : everytype.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", everypercent=").append(everypercent);
        sb.append(", everytype=").append(everytype);
    ...
    public boolean equals(Object that) {
        ...
        Gistotalpercenttemp other = (Gistotalpercenttemp) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getEverypercent() == null ? other.getEverypercent() == null : this.getEverypercent().equals(other.getEverypercent()))
            && (this.getEverytype() == null ? other.getEverytype() == null : this.getEverytype().equals(other.getEverytype()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getEverypercent() == null) ? 0 : getEverypercent().hashCode());
        result = prime * result + ((getEverytype() == null) ? 0 : getEverytype().hashCode());
        return result;
    }
}