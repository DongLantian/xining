...
public class NaturalNow implements Serializable {
    private Integer ntId;

    private Integer ntYear;

    private Integer ntDay;
    ...
    public Integer getNtDay() {
        return ntDay;
    }

    public void setNtDay(Integer ntDay) {
        this.ntDay = ntDay;
    }
    ...
    public boolean equals(Object that) {
        ...
        NaturalNow other = (NaturalNow) that;
