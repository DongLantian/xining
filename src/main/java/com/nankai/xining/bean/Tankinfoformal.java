...
public class Tankinfoformal implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        Tankinfoformal other = (Tankinfoformal) that;
        return (this.getTankid() == null ? other.getTankid() == null : this.getTankid().equals(other.getTankid()))
            && (this.getTanksurveyid() == null ? other.getTanksurveyid() == null : this.getTanksurveyid().equals(other.getTanksurveyid()))
