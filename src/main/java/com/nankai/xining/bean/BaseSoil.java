...
public class BaseSoil implements Serializable {
    private Integer id;
    ...
    public String toString() {
        ...
        sb.append(", cultivateArea=").append(cultivateArea);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getCultivateArea() == null ? other.getCultivateArea() == null : this.getCultivateArea().equals(other.getCultivateArea()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCultivateArea() == null) ? 0 : getCultivateArea().hashCode());
