...
public class CarRepair implements Serializable {
    ...
    public void setSolventAmount(Double solventAmount) {
    ...
    public String toString() {
        ...
        sb.append(", solventAmount=").append(solventAmount);
    ...
    public boolean equals(Object that) {
        ...
        CarRepair other = (CarRepair) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getYear() == null ? other.getYear() == null : this.getYear().equals(other.getYear()))
            && (this.getCompanyId() == null ? other.getCompanyId() == null : this.getCompanyId().equals(other.getCompanyId()))
            && (this.getSolventAmount() == null ? other.getSolventAmount() == null : this.getSolventAmount().equals(other.getSolventAmount()))
            ...
            && (this.getFlagd() == null ? other.getFlagd() == null : this.getFlagd().equals(other.getFlagd()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSolventAmount() == null) ? 0 : getSolventAmount().hashCode());
        ...
        result = prime * result + ((getFlagd() == null) ? 0 : getFlagd().hashCode());
