...
public class FBareSoilDustSourceTemp implements Serializable {
    ...
    public Double getBcEmssion() {
        return bcEmssion;
    }

    public void setBcEmssion(Double bcEmssion) {
        this.bcEmssion = bcEmssion;
    }
    ...
    public String toString() {
        ...
        sb.append(", bcEmssion=").append(bcEmssion);
    ...
    public boolean equals(Object that) {
        ...
        FBareSoilDustSourceTemp other = (FBareSoilDustSourceTemp) that;
        return (this.getBareSoilid() == null ? other.getBareSoilid() == null : this.getBareSoilid().equals(other.getBareSoilid()))
            ...
            && (this.getBcEmssion() == null ? other.getBcEmssion() == null : this.getBcEmssion().equals(other.getBcEmssion()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getBcEmssion() == null) ? 0 : getBcEmssion().hashCode());
        return result;
    }
}