$(function () {
        ...
        methods:{
                                ...
                                success : function(data) { //data为返回的数据
                                    if (data.isDel=="success"){
                                        layer.msg('删除成功', {
                                            ...
                                            layer.close(index);
                                            window.location.href="/Client/auxiliaryroaddust?page=1";
                                        });
                                    }else {
            ...
            editroadDust:function(e) {
                ...
                $.ajax({
                    ...
                    success : function(data) { //data为返回的数据
                        app.roaddust=data;
                        $("#updatedustSuppression").val(data.dustSuppression);
                        $("#updateispave").val(data.ispave);
                    },
                    error : function(XMLResponse) {
                        alert("没有");
                    }
    ...
    $("#updateroadDust").click(function () {
        ...
        if(bootstrapValidator.isValid()){
            app.roaddust.dustSuppression = document.getElementById("updatedustSuppression").value;
            app.roaddust.ispave = document.getElementById("updateispave").value;
            //可以提交
