...
public class FreeStockbreedingCopy implements Serializable {
    private Integer id;
    ...
    public void setEpa(String epa) {
        this.epa = epa == null ? null : epa.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        FreeStockbreedingCopy other = (FreeStockbreedingCopy) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getYear() == null ? other.getYear() == null : this.getYear().equals(other.getYear()))
            && (this.getCountyId() == null ? other.getCountyId() == null : this.getCountyId().equals(other.getCountyId()))
            && (this.getEpa() == null ? other.getEpa() == null : this.getEpa().equals(other.getEpa()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getEpa() == null) ? 0 : getEpa().hashCode());
