...
public class BuildingSmear implements Serializable {
    private Integer id;
    ...
    public String toString() {
        ...
        sb.append(", paintAmount=").append(paintAmount);
    ...
    public boolean equals(Object that) {
        ...
        BuildingSmear other = (BuildingSmear) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getYear() == null ? other.getYear() == null : this.getYear().equals(other.getYear()))
            && (this.getCountyId() == null ? other.getCountyId() == null : this.getCountyId().equals(other.getCountyId()))
            && (this.getPaintAmount() == null ? other.getPaintAmount() == null : this.getPaintAmount().equals(other.getPaintAmount()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPaintAmount() == null) ? 0 : getPaintAmount().hashCode());
