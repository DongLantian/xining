...
public class Wastewateremission implements Serializable {
    private Integer wastewatersurveyid;
    ...
    public Integer getWastewatersurveyid() {
        return wastewatersurveyid;
    }

    public void setWastewatersurveyid(Integer wastewatersurveyid) {
        this.wastewatersurveyid = wastewatersurveyid;
    }
    ...
    public String toString() {
        ...
        sb.append(", wastewatersurveyid=").append(wastewatersurveyid);
    ...
    public boolean equals(Object that) {
        ...
        Wastewateremission other = (Wastewateremission) that;
        return (this.getWastewatersurveyid() == null ? other.getWastewatersurveyid() == null : this.getWastewatersurveyid().equals(other.getWastewatersurveyid()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getWastewatersurveyid() == null) ? 0 : getWastewatersurveyid().hashCode());
