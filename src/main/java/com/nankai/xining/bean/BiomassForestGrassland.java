...
public class BiomassForestGrassland implements Serializable {
    private Integer id;
    ...
    public String toString() {
        ...
        sb.append(", vegetationTypes=").append(vegetationTypes);
        sb.append(", fireArea=").append(fireArea);
        sb.append(", dryBiomass=").append(dryBiomass);
    ...
    public boolean equals(Object that) {
        ...
        BiomassForestGrassland other = (BiomassForestGrassland) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getVegetationTypes() == null ? other.getVegetationTypes() == null : this.getVegetationTypes().equals(other.getVegetationTypes()))
            && (this.getFireArea() == null ? other.getFireArea() == null : this.getFireArea().equals(other.getFireArea()))
            && (this.getDryBiomass() == null ? other.getDryBiomass() == null : this.getDryBiomass().equals(other.getDryBiomass()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getVegetationTypes() == null) ? 0 : getVegetationTypes().hashCode());
        result = prime * result + ((getFireArea() == null) ? 0 : getFireArea().hashCode());
        result = prime * result + ((getDryBiomass() == null) ? 0 : getDryBiomass().hashCode());
