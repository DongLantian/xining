...
public class DryCleaner implements Serializable {
    private Integer id;
    ...
    public String toString() {
        ...
        sb.append(", yearAmount=").append(yearAmount);
    ...
    public boolean equals(Object that) {
        ...
        DryCleaner other = (DryCleaner) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getYearAmount() == null ? other.getYearAmount() == null : this.getYearAmount().equals(other.getYearAmount()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getYearAmount() == null) ? 0 : getYearAmount().hashCode());
